...
def show_image(img):
    ...
    plt.show()
# Codeblock 4
img_original = load_image(path='9.jpeg')
...
# Codeblock 7
def find_contours(img_preprocessed, img_original, epsilon_param=0.01):
...
# Codeblock 8
polygons, img_contours = find_contours(img_preprocessed, img_original,epsilon_param=0.0)
...
# Codeblock 20
show_image(measure_size('8.jpeg'))
show_image(measure_size('2.1.jpg'))
